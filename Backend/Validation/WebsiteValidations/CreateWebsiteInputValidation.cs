...
{
    public class CreateWebsiteInputValidation : AbstractValidator<CreateWebsiteInput>
    {
        public CreateWebsiteInputValidation()
        {
            RuleSet("Create", () =>
            {
                ...
                RuleFor(input => input.RSSUrl).NotEmpty().WithMessage("RSSUrl is required.")
                    ...
                    .WithMessage("RSSUrl must be a valid URL.");
